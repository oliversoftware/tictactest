 ...
 * Time: 11:40
 */
include app_dir.'config/config.ini.php';
...
class mysql_bbdd {
    /*
         ...
         * Database class
         */
    private $db_host = server_mysql;  // Change as required
    private $db_user = user_mysql;  // Change as required
    private $db_pass = pass_mysql;  // Change as required
    private $db_name = bbdd_mysql;	// Change as required
